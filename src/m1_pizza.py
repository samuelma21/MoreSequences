...
def run_test_generate_points_on_circle():
    ...
    # ------------------------------------------------------------------
    expected = [rg.Point( 130.0 , 100.0 ), rg.Point( 129.0 , 105.0 ), rg.Point( 128.0 , 110.0 ),
                rg.Point( 125.0 , 114.0 ), rg.Point( 122.0 , 119.0 ), rg.Point( 119.0 , 122.0 ),
                rg.Point( 115.0 , 125.0 ), rg.Point( 110.0 , 128.0 ), rg.Point( 105.0 , 129.0 ),
                rg.Point( 100.0 , 130.0 ), rg.Point( 94.0 , 129.0 ), rg.Point( 89.0 , 128.0 ),
                rg.Point( 85.0 , 125.0 ), rg.Point( 80.0 , 122.0 ), rg.Point( 77.0 , 119.0 ),
                rg.Point( 74.0 , 115.0 ), rg.Point( 71.0 , 110.0 ), rg.Point( 70.0 , 105.0 ),
                rg.Point( 70.0 , 100.0 ), rg.Point( 70.0 , 94.0 ), rg.Point( 71.0 , 89.0 ),
                rg.Point( 74.0 , 84.0 ), rg.Point( 77.0 , 80.0 ), rg.Point( 80.0 , 77.0 ),
                rg.Point( 84.0 , 74.0 ), rg.Point( 89.0 , 71.0 ), rg.Point( 94.0 , 70.0 ),
                rg.Point( 99.0 , 70.0 ), rg.Point( 105.0 , 70.0 ), rg.Point( 110.0 , 71.0 ),
                rg.Point( 114.0 , 74.0 ), rg.Point( 119.0 , 77.0 ), rg.Point( 122.0 , 80.0 ),
                rg.Point( 125.0 , 85.0 ), rg.Point( 128.0 , 89.0 ), rg.Point( 129.0 , 94.0 ),
                rg.Point( 130.0 , 99.0 )]
    circle = rg.Circle(rg.Point(100,100),30)
    answer = generate_points_on_circle(circle, 36)
...
def run_test_draw_points_on_circle():
    ...
    draw_points_on_circle(window, circle, 26, 'blue')
    window.close_on_mouse_click()
...
def draw_points_on_circle(window, circle, number_of_points, color):
    ...
    for k in range(len(points)):
        smlCirc = rg.Circle(points[k],10)
        smlCirc.fill_color = color
        smlCirc.attach_to(window)
...
def run_test_pizza():
    ...
    pizza(window, circle, 99, 'black', 1)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    polygon(window,circle,10,'hot pink',3)
...
def run_test_fancy_polygon():
    ...
    fancy_polygon(window,circle,50,3,'olive', 4)
    window.close_on_mouse_click()
...
def fancy_polygon(window, circle, number_of_lines,
    ...
    num_points = len(points)
    for k in range(num_points):
        if num_points - 1 < k + hops_to_next_point:
            line = rg.Line(points[k], points[k + hops_to_next_point - num_points])
        else:
